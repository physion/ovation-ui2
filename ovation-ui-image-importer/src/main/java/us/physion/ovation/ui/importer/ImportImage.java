...
import us.physion.ovation.ui.interfaces.InsertEntity;
...
public class ImportImage extends InsertEntity implements EpochGroupInsertable
{
    ...
    public void wizardFinished(WizardDescriptor wd, ovation.IAuthenticatedDataStoreCoordinator dsc, IEntityWrapper iew)
    {
        ...
        for (; ; ) {
            ...
            Map<String, Object> protocolParameters = (Map<String, Object>) wd.getProperty(
                    epochName + ".protocolParameters");
            ...
            for (; ; ) {
                ...
                Map<String, Object> deviceParameters = (Map<String, Object>) wd.getProperty(
